    ...
    <div class="row q-col-gutter-md">
      ...
      <div class="col-12 col-md-8">
        <q-card class="project-details">
          <q-img src="https://cdn.pixabay.com/photo/2015/04/23/22/01/tree-736888_1280.jpg" height="300px">
          ...
          <q-card-section>
            ...
            <p>Rainforests are crucial for maintaining Earth's biodiversity and regulating our climate. Your donation will help us protect these vital ecosystems from deforestation and support local communities.</p>
      ...
      <div class="col-12 col-md-4">
        <q-card class="donation-form q-mb-md">
          <q-card-section>
            ...
            <q-input v-model="donationAmount" type="number" label="Amount (SOL)" class="q-mt-md" />
            <q-btn color="primary" class="full-width q-mt-sm" label="Donate Now" @click="makeDonation" />
          </q-card-section>
        </q-card>
...
const makeDonation = () => {
  ...
  totalRaised.value += donationAmount.value;
